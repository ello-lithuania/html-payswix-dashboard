                  ...
                  <div class="swiper mySwiper">
                    ...
                    <div class="content mt-8 md:mt-16">
                      ...
                      <div id="tabs1" class="js_tab_view">
                        <div class="table-spacing-desktop">
                          <h2>Add Ultimate Beneficial Owner</h2>
                            ...
                            <div class="input-group input-group-end">
                              ...
                              <div>
                                ...
                                <div class="custom-select">
                                <select name="cars" id="cars">
                                <option placeholder="volvo">Select Nationality</option>
                                      <option placeholder="saab">Lithuania</option>
                                      <option placeholder="mercedes">Germany</option>
                                      <option placeholder="audi">Norway</option>
                                </select>
                            ...
                            <div class="input-group input-group-end input-group-mobile-full">
                              <div>
                                ...
                                <input placeholder="Select ID Document Type"/>
                              </div>
                              <div>
                            ...
                            <div class="input-group input-group-end">
                              ...
                              <div>
                                ...
                                <select name="cars" id="cars" class="bg-transparent text-left border-b border-black placeholder-black block w-full py-2 text-base font-medium capitalize outline-0">
                                  <option placeholder="volvo">Enter City</option>
                                      <option placeholder="saab">Lithuania</option>
                                      <option placeholder="mercedes">Germany</option>
                                      <option placeholder="audi">Norway</option>
                                </select>
                        ...
                        <div class="table-spacing-desktop">
                            ...
                            <div class="input-group input-group-end">
                              ...
                              <div>
                                ...
                                <input placeholder="Enter Ownership In %" required>
                              </div>
                            </div>
                            ...
                            <div class="input-group input-group-end">
                              ...
                              <div>
                                ...
                                <div class="input-radio-group-full-inner">
                                  <div class="radio-input-inner">
                                    <input id="radio8" type="radio" name="radio" class="hidden"  />
                                    <label for="radio8">
                                    <span></span>
                                    Yes</label>
                                  </div>
                                  <div class="radio-input-inner">
                                    <input id="radio9" type="radio" name="radio" class="hidden" checked />
                                    <label for="radio9">
                                    <span></span>
                                    No</label>
                                  </div>
                            ...
                            <div class="input-group input-group-end">
                              <div>
                                <label>HAS THE MEMBER ISSUED BEARER SHARES? *</label>

                                <div class="input-radio-group-full-inner">
                                  <div class="radio-input-inner">
                                    <input id="radio10" type="radio" name="radio" class="hidden"  />
                                    <label for="radio10">
                                    <span></span>
                                    Yes</label>
                                  </div>
                            ...
                            <div class="input-group-full">
                              ...
                              <div class="input-radio-group-full">
                                <label>THERE ARE NO NATURAL PERSONS WHO DIRECTLY OR INDIRECTLY OWN OR CONTROL MORE THAN 25% OF SHARES/VOTING RIGHTS OR WHO DIRECTLY/INDIRECTLY CONTROL THE CUSTOMER VIA OTHER MEANS: *</label>
                            ...
                            <div class="input-group-full">
                              <div>
                                <label>PLEASE PROVIDE THE REASON(S) AS TO WHY THERE ARE NO SIGNIFICANT SHAREHOLDERS IN OWNERSHIP STRUCTURE: *</label>
                                <input placeholder="Enter Reason(s)"/>
                              </div>
                            </div>

                            <div class="input-group-full">
                              <div>
                                <label>PLEASE INDICATE WHERE THE INFORMATION ABOUT THE BENEFICIAL OWNER CAN BE VERIFIED *</label>
                                <input placeholder="Enter Indication About Shareholder"/>
                              </div>
                            </div>
                    ...
                    <div class="tab-btn-container">
                      ...
                      <div>
                        ...
                        <button type="submit" class="btn-success finish-tabs-btn hidden">Add BENEFICIAL OWNER</button>
                      </div>
                    </div>
